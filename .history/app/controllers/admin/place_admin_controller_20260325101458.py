...
async def update_place(place_id: str, data: PlaceUpdate, collection, category_collection):
    ...
    old_category_id = place.get("category_id")
...
async def delete_place(place_id: str, collection, category_collection):
    ...
    # Remove place_id từ category's places
    await category_collection.update_one(
        {"_id": ObjectId(place["category_id"])},
        {"$pull": {"places": place_id}}
    )
